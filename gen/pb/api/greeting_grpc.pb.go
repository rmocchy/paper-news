...
const (
	GreetingService_Greet_FullMethodName = "/greeting.GreetingService/Greet"
)
...
type GreetingServiceClient interface {
	Greet(ctx context.Context, in *GreetRequestPayload, opts ...grpc.CallOption) (*GreetResponsePayload, error)
}
...
func (c *greetingServiceClient) Greet(ctx context.Context, in *GreetRequestPayload, opts ...grpc.CallOption) (*GreetResponsePayload, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreetResponsePayload)
...
type GreetingServiceServer interface {
	Greet(context.Context, *GreetRequestPayload) (*GreetResponsePayload, error)
...
func (UnimplementedGreetingServiceServer) Greet(context.Context, *GreetRequestPayload) (*GreetResponsePayload, error) {
...
func _GreetingService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServiceServer).Greet(ctx, req.(*GreetRequestPayload))
	}
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api-server/greeting.proto",
}
